...
export default function NuevoItem() {
  ...
  const categorias =  ["costura", "algodon", "nylon", "lycra", "goma", "tarugo", "etiqueta", "bolsa", "percha", "ribbon", "caja", "cinta", "plantilla", "film", "consumibes(aceite y parafina)", "faja", "caballete"]
